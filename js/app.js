...
***************************************************************************** */
        ...
        const mainpageProductCard = document.querySelector(".mainpage-product-card");
        if (headerWrapper && mainpageProductCard) {
            const backgroundWrapper = document.createElement("div");
            backgroundWrapper.classList.add("background-image");
            backgroundWrapper.appendChild(headerWrapper);
            backgroundWrapper.appendChild(mainpageProductCard);
        ...
        const buttons = document.querySelectorAll(".mainpage-btn, .mainpage-product__button, .mainpage-buttons__btn, .mainpage-buttons__btn_color, .mainpage-product__btn-like, .mainpage-product__btn-cart, .mainpage-payment__btn-like");
